...
title('Polar RZ %50-Duty transmit data')
% Set axes and labels.
...
title('Polar RZ %50-Duty channel output fc=500 Hz - Rb=1kbps')
...
subplot(425)
plot(to, RZ_channel_out, 'b'); hold on;
title('Polar RZ %50-Duty channel output fc=1000 Hz - Rb=1kbps')
%stem(tx, x, 'kx'); hold off;
axis([0 25 -6 6]);  xlabel('Time (ms)'); ylabel('Amplitude');
fpass=2000; %change!
RZ_channel_out = lowpass(RZ_out,fpass,Fs);
subplot(427)
plot(to, RZ_channel_out, 'b'); hold on;
title('Polar RZ %50-Duty channel output fc=2000 Hz - Rb=1kbps')
%stem(tx, x, 'kx'); hold off;
axis([0 25 -6 6]);  xlabel('Time (ms)'); ylabel('Amplitude');
%% tek kutup icin
...
subplot(422)
plot(to, RZ_out, 'r-'); hold off;
title('Unipolar RZ %50-Duty transmit data')
% Set axes and labels.
axis([0 25 -6 6]);  xlabel('Time (ms)'); ylabel('Amplitude');
...
subplot(424)
plot(to, RZ_channel_out, 'b'); hold on;
title(' Unipolar RZ %50-Duty channel output fc=500 Hz - Rb=1kbps')
%stem(tx, x, 'kx'); hold off;
axis([0 25 -6 6]);  xlabel('Time (ms)'); ylabel('Amplitude');
fpass=1000; %change!
RZ_channel_out = lowpass(RZ_out,fpass,Fs);
subplot(426)
plot(to, RZ_channel_out, 'b'); hold on;
title('Unipolar RZ %50-Duty channel output fc=1000 Hz - Rb=1kbps')
% stem(tx, x, 'kx'); hold off;
axis([0 25 -6 6]);  xlabel('Time (ms)'); ylabel('Amplitude');
fpass=2000; %change!
RZ_channel_out = lowpass(RZ_out,fpass,Fs);
subplot(428)
plot(to, RZ_channel_out, 'b'); hold on;
title('Unipolar RZ %50-Duty channel output fc=2000 Hz - Rb=1kbps')
% stem(tx, x, 'kx'); hold off;
axis([0 25 -6 6]);  xlabel('Time (ms)'); ylabel('Amplitude');